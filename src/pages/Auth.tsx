...
import { Printer, LogIn, UserPlus, Mail } from 'lucide-react';
import { z } from 'zod';
...
const Auth = () => {
  ...
  const validateForm = () => {
    ...
    try { emailSchema.parse(email); } catch (error) {
      if (error instanceof z.ZodError) newErrors.email = error.issues[0].message;
    }
    try { passwordSchema.parse(password); } catch (error) {
      if (error instanceof z.ZodError) newErrors.password = error.issues[0].message;
    }
    setErrors(newErrors);
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Sign in to place orders and access advanced features
          </p>
        </div>
          ...
          <CardHeader>
            <Tabs value={isSignUp ? "signup" : "signin"} onValueChange={(value) => setIsSignUp(value === "signup")}>
              ...
              <TabsContent value="signup" className="space-y-2 mt-6">
                ...
                <CardDescription>Join us to save your calculations and access premium features</CardDescription>
              </TabsContent>
            </Tabs>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {isSignUp && (
                <div className="space-y-2">
                  ...
                  <Input id="displayName" type="text" placeholder="Enter your display name" value={displayName} onChange={(e) => setDisplayName(e.target.value)} />
                </div>
              )}
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="password" type="password" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} className={errors.password ? "border-destructive" : ""} />
